...
function createInfo(r) {
  ...
  html += '   <span class="info">' + r.main.temp_max + '˚</span>';
  html += '   <span class="divide">|</span>';
  html += '   <span class="title">최저</span>';
  html += '   <span class="info">' + r.main.temp_min + '˚</span>';
  html += '  </div>';
  html += '  <div class="wind">';
...
function onCreatMarker(r) {
  ...
  content += '<div class="current-temp">' + r.main.temp + '</div>';
  content += '</div>';
  content += '<div>';
  content += '<span class="max-temp">최고:' + r.main.temp_max + '˚C</span>';
  content += '<span class="min-temp">최저:' + r.main.temp_min + '˚C</span>';
  content += '</div>';
  content += '</div>';
